// Package profile computes statistical profiles for table columns including
// min, max, mean, median, standard deviation, null rate, percentiles, and
// data type distribution. Profiles support quality analysis by identifying
// columns with unusual distributions or excessive null rates.
package profile
...
// ColumnProfile holds statistical information about a single column.
...
// TableProfile holds profiles for all columns in a table.
type TableProfile struct {
	Columns []ColumnProfile `json:"columns"`
	Rows    int             `json:"rows"`
}

// ProfileTable computes a full profile for every column in the table.
...
// ProfileColumn computes a profile for a single named column.
...
// Summary returns a multi-line text summary of the table profile.
