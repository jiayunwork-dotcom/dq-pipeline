...
func TestPipelineCancellationPreservesCompleted(t *testing.T) {
	...
	// fast stage should have completed successfully
...
func TestPipelineFilterStage(t *testing.T) {
	...
	// Carol has empty age, should be filtered
